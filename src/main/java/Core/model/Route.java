...
public Route(){
    ...
    public Route(String id, String route_id, String route_short_name, String route_long_name, String route_desc, RouteType route_type, String route_url, String route_color, String route_text_color) {
        super(id);
